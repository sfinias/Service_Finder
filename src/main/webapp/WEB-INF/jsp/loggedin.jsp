            ...
            <div class="site-navbar bg-light">
                <div class="py-1">
                    <div class="row align-items-center">
                        <div class="col-2">
                            <h2 class="mb-0 site-logo"><a href="index.html">Service<strong class="font-weight-bold">Finder</strong>
                            </a></h2>
                        </div>
                        <div class="col-10">
                            ...
                            <div class="col-md-9">
                                <div class="row">
                                    <div class="col-md-6 mb-3 mb-md-0">
                                        <select class="form-control form-control-block search-input  border-0 px-4" id="inputGroupSelect02">
                                    ...
                                    <div class="col-md-6 mb-3 mb-md-0">
                                        <div class="input-wrap">
                                            ...
                                            <select class="form-control form-control-block search-input  border-0 px-4" id="inputGroupSelect03" placeholder="city, province or region" onFocus="geolocate()">
